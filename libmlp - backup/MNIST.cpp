...
void MNIST::ReadInput(string filename,int num_images, float** inputs)
{
    ifstream image_file(filename, ios::binary); // read MNIST-image database
    cout << "Reading  Training file : " << filename << endl;
...
void MNIST::ReadLabel(string filename,int num_labels, float** outputs)
{
