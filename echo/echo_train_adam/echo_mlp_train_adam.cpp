...
void ACCURACYandLOSS(int Iteration_boucle,float **Donne_Entree,float **Donne_Desiree, MLP_Network_ADAM & mlp_fonction, float *Accuracy, float *Loss)
{
        int sums=0;
...
int main(int argc, char *argv[])
{
    ...
    MLP_Network_ADAM mlp(0.8, 0.9, 'L');
