...
#ifndef MLP_Layer_AMSGrad_H
#define MLP_Layer_AMSGrad_H
...
class  MLP_Layer_AMSGrad : public MLP_Layer
{
protected:
    ...
    INTERNAL_FLOAT_TYPE* SW_hat;

    INTERNAL_FLOAT_TYPE* Mb;
    INTERNAL_FLOAT_TYPE* Sb;
    INTERNAL_FLOAT_TYPE* Sb_hat;
...
public:
	...
	//! contructeur
    MLP_Layer_AMSGrad(INTERNAL_FLOAT_TYPE beta1=0.9, INTERNAL_FLOAT_TYPE beta2=0.99, char activation_function='L'):
        MLP_Layer(activation_function),
        Beta1(beta1), Beta2(beta2), T(1), Epsilon(0.0000001)
       { MW = nullptr; Mb = nullptr; SW = nullptr; Sb = nullptr; }
    //! destructeur
    virtual ~MLP_Layer_AMSGrad()    {   Delete();   }
