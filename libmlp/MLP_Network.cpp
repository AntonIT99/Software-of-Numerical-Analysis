...
void MLP_Network::UpdateWeight(float learningRate)   // update weight according gradient and standart gradient descent
{
...
float MLP_Network::CostFunction(float* desiredOutput)
{
...
float MLP_Network::CalculateResult(float* desiredOutput)
{
    int maxIdx = 0;
...
ifstream& operator>>(ifstream& is, MLP_Network& mlp)
{
...
ofstream& operator<<(ofstream& os, const MLP_Network& mlp)
{
